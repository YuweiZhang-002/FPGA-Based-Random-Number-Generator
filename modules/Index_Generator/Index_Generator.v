...
module index_generator (
	...
	initial 
	 ...
	 // Output index exceed signal if all the values are applied
	 assign index_exceed = Cell_ptr == 0;
	     ...
	     begin
	      ...
	      begin
            if (state == state_working) begin // If system is in state_working
               if (random_value < (Cell_ptr)) // If not reaches to the maximum
